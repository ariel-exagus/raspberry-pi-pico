 ...
 *NOTE: If you want to locate your project in other directory, you have to modify the* `pimoroni_pico_import.cmake` *file. You have to add the relative path to Pimoroni Libraries from* `PICO_SDK_PATH` *enviroment variable.*
