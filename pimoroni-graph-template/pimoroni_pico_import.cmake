...
if (NOT PIMORONI_PICO_PATH)
    if (PIMORONI_PICO_FETCH_FROM_GIT)
        ...
        # ARI Note: modifies this Path to access correctly to pimoroni pico library
    elseif(PICO_SDK_PATH AND EXISTS "${PICO_SDK_PATH}/../../pimoroni/pimoroni-pico")
        set(PIMORONI_PICO_PATH ${PICO_SDK_PATH}/../../pimoroni/pimoroni-pico)
